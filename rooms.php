...
<head>
    ...
    <link class="cdn" rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css" />
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 px-4" id="rooms-data">
                <?php
                    // Fetch active and non-removed rooms from database using clean select function
                    $room_res = select("SELECT * FROM `rooms` WHERE `status`=? AND `removed`=? ORDER BY `id` DESC", [1, 0], 'ii');

                    while($room_data = mysqli_fetch_assoc($room_res)) {
                        
                        // Fetch Features for each room using select function to prevent global connection conflict errors
                        ...
                        // Fetch Facilities for each room using select function
                        ...
                        // Get Room Thumbnail Image using select function
